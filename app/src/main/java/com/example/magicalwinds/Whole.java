...
public class Whole extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prodRef = FirebaseDatabase.getInstance().getReference().child("Products").child("Masalas and Spices -> Whole Spices");
        Cat="Masalas and Spices -> Whole Spices";
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Whole.this,ProductDetailsActivity.class);
    ...
    public void back_button(View view) {
        Intent i = new Intent(Whole.this,SearchActivity.class);
        i.putExtra("Category",Cat);
        startActivity(i);
        finish(); }
    public void Go_to_home(View view) {
        Intent i = new Intent(Whole.this, HomeActivity.class);
        startActivity(i);
        finish(); }
}
