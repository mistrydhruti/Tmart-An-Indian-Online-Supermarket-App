...
public class HomeKitchen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prodRef = FirebaseDatabase.getInstance().getReference().child("Products").child("Home and Kitchen -> Home and Kitchen");

        Cat="Home and Kitchen -> Home and Kitchen";
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(HomeKitchen.this,ProductDetailsActivity.class);
    ...
    public void back_button(View view) {
        Intent i = new Intent(HomeKitchen.this,SearchActivity.class);
        i.putExtra("Category",Cat);
        startActivity(i);
        finish(); }
    public void Go_to_home(View view) {
        Intent i = new Intent(HomeKitchen.this, HomeActivity.class);
        startActivity(i);
        finish(); }
}
