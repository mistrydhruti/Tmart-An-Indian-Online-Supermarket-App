...
public class Herbs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prodRef = FirebaseDatabase.getInstance().getReference().child("Products").child("Masalas and Spices -> Herbs and Seasonings");
        Cat="Masalas and Spices -> Herbs and Seasonings";
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Herbs.this,ProductDetailsActivity.class);
    ...
    public void back_button(View view) {
        Intent i = new Intent(Herbs.this,SearchActivity.class);
        i.putExtra("Category",Cat);
        startActivity(i);
        finish(); }
    public void Go_to_home(View view) {
        Intent i = new Intent(Herbs.this, HomeActivity.class);
        startActivity(i);
        finish(); }
}
