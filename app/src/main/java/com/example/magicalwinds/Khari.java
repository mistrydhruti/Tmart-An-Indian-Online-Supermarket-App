...
public class Khari extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khari);

        prodRef = FirebaseDatabase.getInstance().getReference().child("Products").child("Biscuits and Cookies -> Khari and Toast");
        Cat="Biscuits and Cookies -> Khari and Toast";
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Khari.this,ProductDetailsActivity.class);
    ...
    public void back_button(View view) {
        Intent i = new Intent(Khari.this,SearchActivity.class);
        i.putExtra("Category",Cat);
        startActivity(i);
        finish(); }
    public void Go_to_home(View view) {
        Intent i = new Intent(Khari.this, HomeActivity.class);
        startActivity(i);
        finish(); }
}
