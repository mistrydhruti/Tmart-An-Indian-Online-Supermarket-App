...
public class WaferBiscuits extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wafer_biscuits);

        prodRef = FirebaseDatabase.getInstance().getReference().child("Products").child("Biscuits and Cookies -> Wafer Biscuits");
        Cat="Biscuits and Cookies -> Wafer Biscuits";
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(WaferBiscuits.this,ProductDetailsActivity.class);
    ...
    public void back_button(View view) {
        Intent i = new Intent(WaferBiscuits.this,SearchActivity.class);
        i.putExtra("Category",Cat);
        startActivity(i);
        finish(); }
    public void Go_to_home(View view) {
        Intent i = new Intent(WaferBiscuits.this, HomeActivity.class);
        startActivity(i);
        finish(); }
}
