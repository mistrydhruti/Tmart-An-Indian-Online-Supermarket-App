...
public class BlendedOil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blended_oil);
        prodRef= FirebaseDatabase.getInstance().getReference().child("Products").child("Cooking Oil -> Blended Oil");
        Cat="Cooking Oil -> Blended Oil";
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(BlendedOil.this,ProductDetailsActivity.class);
    ...
    public void back_button(View view) {
        Intent i = new Intent(BlendedOil.this,SearchActivity.class);
        i.putExtra("Category",Cat);
        startActivity(i);
        finish(); }
    public void Go_to_home(View view) {
        Intent i = new Intent(BlendedOil.this, HomeActivity.class);
        startActivity(i);
        finish(); }
}
