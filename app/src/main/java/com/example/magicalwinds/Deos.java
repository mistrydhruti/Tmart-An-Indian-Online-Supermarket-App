...
public class Deos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deos);

        prodRef= FirebaseDatabase.getInstance().getReference().child("Products").child("Personal Care -> Deos and Perfumes");
        Cat="Personal Care -> Deos and Perfumes";
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Deos.this,ProductDetailsActivity.class);
    ...
    public void back_button(View view) {
        Intent i = new Intent(Deos.this,SearchActivity.class);
        i.putExtra("Category",Cat);
        startActivity(i);
        finish(); }
    public void Go_to_home(View view) {
        Intent i = new Intent(Deos.this, HomeActivity.class);
        startActivity(i);
        finish(); }
}
