...
public class Muesli extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muesli);

        prodRef = FirebaseDatabase.getInstance().getReference().child("Products").child("Breakfast and Cereals -> Muesli");
        Cat="Breakfast and Cereals -> Muesli";
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final ProductModel model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(Muesli.this,ProductDetailsActivity.class);
    ...
    public void back_button(View view) {
        Intent i = new Intent(Muesli.this,SearchActivity.class);
        i.putExtra("Category",Cat);
        startActivity(i);
        finish(); }
    public void Go_to_home(View view) {
        Intent i = new Intent(Muesli.this, HomeActivity.class);
        startActivity(i);
        finish(); }
}
